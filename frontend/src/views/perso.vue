          ...
          <div class="col-12 col-xl-6 left-bloc">
            ...
            <nav>
              <ul class="list_nav item4">
                ...
                <li class="list_item">
                  <router-link to="/elvira">Creació</router-link>
                </li>
                <li class="list_item">
        ...
        <div class="row col-12" id="spectacle">
          ...
          <div class="espectacle-bloc col-lg-3 col-xl-3" v-for="i in imgData" :key="i._id">
            <div class="bloc-img-spect ">
              <router-link to="/elvira" >
              <img  class=" img-spectacle rounded-circle" :src="i.imageUrl" alt="" />
              <h3 class="showName">{{i.showName}} </h3>
               </router-link>
            </div>
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      getPageData() {
        ...
        .then((res)=>{
  if(res){
    console.log("RES GET PORTADA",res.data[0].name);
