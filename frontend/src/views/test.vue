...
.meeting-item {
  ...
  box-shadow: 1px 1px 16px 0px rgba(7, 7, 7, 0.6);
  height: 230px;
}

.meeting-item:hover {
  box-shadow: 1px 1px 26px 0px rgb(116, 116, 116);
...
.month_date h3 {
  ...
  box-shadow: 1px 1px 26px 0px rgba(116, 116, 116, 0.6);
}
