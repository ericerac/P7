    ...
    <div class="container">
      <form class="updateProfil-form">
        ...
        <div class="fond-form">
          ...
          <div class="form-group">
            <label for="image">Choisissez une photo de profil
          ...
          <div class="form-group">
            <label>Prénom</label>
            <input v-model="user.lastName" type="text" name="prenom" class="form-control" placeholder="Prénom"
              required />
          </div>
          <div class="form-group">
            <label>Email</label>
